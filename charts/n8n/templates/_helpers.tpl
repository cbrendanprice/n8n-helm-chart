...
{{- if or .Values.n8n.encryption_key (and .Values.n8n.existingSecret .Values.n8n.encryption_key_in_existing_secret) }}
- name: "N8N_ENCRYPTION_KEY"
  valueFrom:
    secretKeyRef:
      key: N8N_ENCRYPTION_KEY
      name: {{ if (and .Values.n8n.existingSecret .Values.n8n.encryption_key_in_existing_secret) }}{{ .Values.n8n.existingSecret | trim }}{{ else }}{{ include "n8n.fullname" . }}{{ end }}
{{- end }}
