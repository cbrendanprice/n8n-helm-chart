...
{{- if or .Values.n8n.encryption_key (and .Values.n8n.existingSecret .Values.n8n.encyyption_key_in_existing_secret) }}
- name: "N8N_ENCRYPTION_KEY"
  valueFrom:
    secretKeyRef:
      key: N8N_ENCRYPTION_KEY
      name: {{ if (and .Values.n8n.existingSecret .Values.n8n.encyyption_key_in_existing_secret) }}{{ .Values.n8n.existingSecret | trim }}{{ else }}{{ include "n8n.fullname" . }}{{ end }}
{{- end }}
...
- name: "EXECUTIONS_MODE"
  value: "queue"
{{- end }}
{{- if or .Values.scaling.redis.existingSecret }}
- name: "QUEUE_BULL_REDIS_PASSWORD"
  valueFrom:
    secretKeyRef:
      key: {{ .Values.scaling.redis.existingSecretPasswordKey | default "password" }}
      name: {{ .Values.scaling.redis.existingSecret | trim }}
{{- else if .Values.scaling.redis.password }}
- name: "QUEUE_BULL_REDIS_PASSWORD"
